<?php
namespace T3kit\themeT3kit\Resource\Rendering;
...
/**
 * Class ImageRenderer
 * @package \T3kit\themeT3kit\Resource\Rendering
 */
class ImageRenderer implements FileRendererInterface
{
    ...
    public function render(
        ...
        if($this->defaultWidth === 0) {
            $this->defaultWidth = $file->getProperty('width');
        }
        $this->defaultHeight = $height;
        if($this->defaultHeight === 0) {
            $this->defaultHeight = $file->getProperty('height');
        }
